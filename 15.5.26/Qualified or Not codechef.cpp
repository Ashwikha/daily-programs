...
Given that TanMinati solved 
X
X problems and Bhavy solved 
Y
Y problems, determine whether a participant who solved 
N
N problems can participate in the next round.

Input Format
The first and only line of input will contain three integers 
N
N, 
X
X, and 
Y
Y, denoting the number of problems solved by the participant, TanMinati, and Bhavy respectively.
Output Format
...
2
X
N≥2X means the participant defeats TanMinati.
N
≥
2
Y
N≥2Y means the participant defeats Bhavy as well.
...
2
X
N<2X so TanMinati is undefeated.
N
≥
2
Y
N≥2Y means the participant defeats Bhavy.
